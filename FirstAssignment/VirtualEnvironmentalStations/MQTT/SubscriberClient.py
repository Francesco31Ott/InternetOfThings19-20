...
dynamodb = boto3.resource('dynamodb', region_name='us-east-1')      # connection to dynamodb
dynamoTable = dynamodb.Table('EnvironmentalStationDB')              # and its table
jsonP = '';

def on_connect(client, userdata, flags, rc):                        # function for making connection
    print("Connection returned result: " + str(rc))
    client.subscribe("sensor/data" , 0)                             # subscribe to the topic
